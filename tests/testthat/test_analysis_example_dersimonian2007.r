...
test_that("results are correct for the CLASP example.", {
   ...
   expected <- structure(c( 0.3681,  0.441,   0.2323, 0.3831,  0.3254,  0.3681,  0.0023,  0.1843, 0.133,   0.4572,  0.4084,
                           -0.3811, -0.4035, -0.324, -0.3861, -0.3655, -0.3811, -0.1974, -0.298, -0.2666, -0.4079, -0.3941,
                            0.206,   0.2327,  0.154,  0.2115,  0.1901,  0.206,   0.0694,  0.1343, 0.1125,  0.2386,  0.2208),
