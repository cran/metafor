...
test_that("results are correct for the multiple-treatment studies example with risk differences.", {
   ...
   expect_that(round(dat$yi,4), is_equivalent_to(c(0.0150, 0.0025, 0.0125, 0.0350, -0.0050, 0.0250)))
   ...
   expect_that(round(coef(res),4), is_equivalent_to(c(0.0200, 0.0043, 0.0211)))
   ...
   expect_that(round(res$QE,3), is_equivalent_to(7.191))
...
test_that("results are correct for the multiple-treatment studies example with log odds ratios.", {
   ...
   expect_that(round(dat$yi,4), is_equivalent_to(c(0.4855, 0.0671, 0.3008, 0.6657, -0.0700, 0.4321)))
   ...
   expect_that(round(coef(res),4), is_equivalent_to(c(0.5099, 0.0044, 0.4301)))
   ...
   ### compare with results on page 363
   expect_that(round(res$QE,3), is_equivalent_to(2.056)) ### 2.057 in chapter
...
test_that("results are correct for the multiple-treatment studies example with log risk ratios.", {
   ...
   expect_that(round(dat$yi,4), is_equivalent_to(c(0.4700, 0.0645, 0.2877, 0.6286, -0.0645, 0.4055)))
   ...
   ### compare with results on page 363
   expect_that(round(coef(res),4), is_equivalent_to(c(0.4875, 0.0006, 0.4047)))
   ...
   ### (results for this not given in chapter)
   expect_that(round(res$QE,3), is_equivalent_to(1.895))
...
test_that("results are correct for the multiple-treatment studies example with difference of arcsine transformed risks.", {
   ...
   ### compare with results on page 364
   expect_that(round(dat$yi*2,4), is_equivalent_to(c(0.0852, 0.0130, 0.0613, 0.1521, -0.0187, 0.1038))) ### need *2 factor due to difference in definition of measure
   ...
   expect_that(round(coef(res)*2,4), is_equivalent_to(c(0.1010, 0.0102, 0.0982)))
   ...
   ### compare with results on page 365
   expect_that(round(res$QE,3), is_equivalent_to(4.263)) ### 4.264 in chapter
...
test_that("results are correct for the multiple-treatment studies example with standardized mean differences.", {
   ...
   ### compare with results on page 364
   expect_that(round(dat$yi,4), is_equivalent_to(c(2.1670, 1.3406, 2.8927, 2.1754, 2.3821, 1.6664)))
   ...
   expect_that(round(coef(res),3), is_equivalent_to(c(2.374, 1.570)))
   ...
   ### compare with results on page 367
   expect_that(round(res$QE,3), is_equivalent_to(3.945))
...
test_that("results are correct for the multiple-endpoint studies example with standardized mean differences.", {
   ...
   ### (results for this not given in chapter)
   expect_that(round(coef(res),3), is_equivalent_to(c(0.362, 0.205)))
   ...
   expect_that(round(res$QE,2), is_equivalent_to(19.63)) ### 19.62 in chapter
