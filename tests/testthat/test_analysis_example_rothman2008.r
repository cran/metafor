...
test_that("the to.long() function works.", {
   ...
   expected <- structure(list(age = c("Age <55", "Age <55", "Age 55+", "Age 55+"),
      ...
      study = structure(c(2L, 2L, 1L, 1L), levels = c("Age 55+", "Age <55"), class = "factor"),
      group = structure(c(2L, 1L, 2L, 1L), levels = c("2", "1"), class = "factor"),
...
test_that("the to.long() function works.", {
   ...
   expected <- structure(list(age = c("35-44", "35-44", "45-54", "45-54", "55-64", "55-64", "65-74", "65-74", "75-84", "75-84"),
      ...
      study = structure(c(1L, 1L, 2L, 2L, 3L, 3L, 4L, 4L, 5L, 5L), levels = c("35-44", "45-54", "55-64", "65-74", "75-84"), class = "factor"),
      group = structure(c(2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L), levels = c("2", "1"), class = "factor"),
...
test_that("the to.long() function works.", {
   ...
   expected <- structure(list(age = c("<35", "<35", "35+", "35+"),
      ...
      study = structure(c(2L, 2L, 1L, 1L), levels = c("35+", "<35"), class = "factor"),
      group = structure(c(1L, 2L, 1L, 2L), levels = c("1", "2"), class = "factor"),
